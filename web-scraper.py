...
def scrapeTopKaraokeSongs(url):
    ...
    writeSonglistCSV(songs_for_this_url, 'song_list1.csv') # writes to song_list.csv after each page so the code doesn't need to run all the way
...
song_list_from_google = scrapeFromGoogle("https://www.google.com/search?rlz=1C1CHFX_enUS704US704&ei=fYuzXdq9MY3b5gKxzITIBg&q=best+karaoke+songs&oq=best+karaoke+songs&gs_l=psy-ab.3..0i71l8.0.0..3240278...0.2..0.0.0.......0......gws-wiz.HjPC1IKlIYs&ved=0ahUKEwia8OGZzrjlAhWNrVkKHTEmAWkQ4dUDCAs&uact=5", scrapeTopKaraokeSongs)
